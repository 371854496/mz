...
(function(root, factory) {
	...
	if (typeof define === "function" && define.amd) {
		define(["jquery", "js/jQuery-photoClip/iscroll-zoom", "js/jQuery-photoClip/hammer", "lrz"], factory);
	} else if (typeof exports === "object") {
		module.exports = factory(require("jquery"), require("js/jQuery-photoClip/iscroll-zoom"), require("js/jQuery-photoClip/hammer"), require("lrz"));
	} else {
		root.bjj = root.bjj || {};
